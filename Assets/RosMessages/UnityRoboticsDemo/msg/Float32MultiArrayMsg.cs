...
namespace RosMessageTypes.UnityRoboticsDemo
{
    ...
    {
        public const string k_RosMessageName = "unity_robotics_demo_msgs/Float32MultiArray";
        ...
        public static Float32MultiArrayMsg Deserialize(MessageDeserializer deserializer) => new Float32MultiArrayMsg(deserializer);

        private Float32MultiArrayMsg(MessageDeserializer deserializer)
        {
