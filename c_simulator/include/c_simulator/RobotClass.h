...
public:
  ...
  vXd realizedThrusters() const { return actuator.forces(); }
  double simulationTime() const { return actuator.time(); }
...
private:
  ...
  double
      thrusterDeadband; // Requested forces below this magnitude are zeroed, N
  ...
  geometry_msgs::msg::Transform safeTransform(std::string toFrame,
